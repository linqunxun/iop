...
export default class Scenes extends Vue {
  ...
  public retrieveAllSceness(): void {
  ...
  public prepareRemove(instance: IScenes): void {
  ...
  public removeScenes(): void {
    this.scenesService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('iopApp.scenes.deleted', { param: this.removeId });
