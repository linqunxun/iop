...
/**
 * REST controller for managing {@link com.iop.domain.Model}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ModelResource {
        ...
        Optional<Model> result = modelRepository
            ...
            .map(
                existingModel -> {
                    ...
                    if (model.getCodeName() != null) {
                        existingModel.setCodeName(model.getCodeName());
                    }
    ...
    public ResponseEntity<List<Model>> getAllModels(
        ...
        Page<Model> page;
        if (eagerload) {
            page = modelRepository.findAllWithEagerRelationships(pageable);
        } else {
