...
import com.iop.repository.EnterpriseRepository;
...
class EnterpriseResourceIT {
    ...
    public static Enterprise createEntity(EntityManager em) {
        Enterprise enterprise = new Enterprise().name(DEFAULT_NAME).areaCode(DEFAULT_AREA_CODE);
        return enterprise;
    }
    ...
    public static Enterprise createUpdatedEntity(EntityManager em) {
        Enterprise enterprise = new Enterprise().name(UPDATED_NAME).areaCode(UPDATED_AREA_CODE);
        return enterprise;
    }
    ...
    void createEnterprise() throws Exception {
        ...
        assertThat(testEnterprise.getAreaCode()).isEqualTo(DEFAULT_AREA_CODE);
    }
    ...
    void putNewEnterprise() throws Exception {
        ...
        updatedEnterprise.name(UPDATED_NAME).areaCode(UPDATED_AREA_CODE);
        ...
        assertThat(testEnterprise.getAreaCode()).isEqualTo(UPDATED_AREA_CODE);
    }
    ...
    void partialUpdateEnterpriseWithPatch() throws Exception {
        ...
        partialUpdatedEnterprise.name(UPDATED_NAME);
    ...
    void fullUpdateEnterpriseWithPatch() throws Exception {
        ...
        partialUpdatedEnterprise.name(UPDATED_NAME).areaCode(UPDATED_AREA_CODE);
    ...
    void deleteEnterprise() throws Exception {
        ...
        restEnterpriseMockMvc
            .perform(delete(ENTITY_API_URL_ID, enterprise.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
