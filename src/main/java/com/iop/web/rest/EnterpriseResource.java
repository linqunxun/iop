...
/**
 * REST controller for managing {@link com.iop.domain.Enterprise}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EnterpriseResource {
    ...
    public ResponseEntity<Enterprise> createEnterprise(@RequestBody Enterprise enterprise) throws URISyntaxException {
            ...
            .map(
                existingEnterprise -> {
                    ...
                    if (enterprise.getAreaCode() != null) {
                        existingEnterprise.setAreaCode(enterprise.getAreaCode());
                    }
