...
export default class Enterprise extends Vue {
  ...
  public retrieveAllEnterprises(): void {
  ...
  public prepareRemove(instance: IEnterprise): void {
  ...
  public removeEnterprise(): void {
    this.enterpriseService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('iopApp.enterprise.deleted', { param: this.removeId });
